...
import { checkingCloses, deleteFiles } from '../api/helpers';
...
import { isBeta, saveToken, SessionTokenCkeck } from './auth';
import {
  getWhatsappPage, initBrowser, initWhatsapp, injectApi
} from './browser';
